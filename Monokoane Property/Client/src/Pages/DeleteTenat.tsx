...
const DeleteTenant: React.FC = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5153/api/tenant/${id}`, {
        method: 'DELETE',
        headers
      });
    ...
    <div className="container py-4" style={{ maxWidth: '600px' }}>
        ...
        <div className="card-header bg-danger text-white">
          <h2 className="mb-0">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" 
              className="bi bi-person-x me-2" viewBox="0 0 16 16">
              <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm.93 5.412-4.333 2A1.5 1.5 0 0 1 4 13.5V9c0-.293.126-.555.326-.752l2.4-2.122a2.5 2.5 0 0 1 3.368 0l2.4 2.122A1.5 1.5 0 0 1 12 9v4.5c0 .276-.124.531-.333.712l-4.334 2a1.5 1.5 0 0 1-1.4-1.588Z"/>
              <path d="M8 12a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-1 0v-1A.5.5 0 0 1 8 12Zm0-5a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0v-4A.5.5 0 0 1 8 7Z"/>
            </svg>
            Delete Tenant
          </h2>
        </div>
        <div className="card-body">
          ...
          {success && (
            <div className="alert alert-success alert-dismissible fade show">
              <div className="d-flex align-items-center">
                ...
                <div>Tenant deleted successfully!</div>
              </div>
              <button 
                type="button" 
                className="btn-close" 
          ...
          {!success && (
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label className="form-label fw-bold">Tenant ID to Delete</label>
                <div className="input-group">
                  <span className="input-group-text">#</span>
                  <input
                    type="number"
                    className="form-control"
                    placeholder="Enter tenant ID (e.g., 5)"
                    value={tenantId}
              ...
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <p>Are you sure you want to delete tenant <strong>#{tenantId}</strong>?</p>
      ...
      <div className="mt-3 text-center text-muted small">
        <p>
          ...
          Tenant ID must exist in the system
        </p>
      </div>
    </div>
  );
